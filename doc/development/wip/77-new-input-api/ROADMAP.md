...
notes, ledger entries and live goals (`T-RETIRED-UNVER`, `T-NEVER-SHIPPED`, `T-MERMAID-MODEL`;
`T-KEYSET-SPLIT` was among them until `FIX-02-25` retired it, 2026-09-02), and a renumber this
