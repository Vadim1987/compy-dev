...
| **P8** | W8 — test restructuring. **PART DONE**: R058/R059/R060/R061 (tracer + matrix supersession), R067 (NFR narrowing), R068 (blind row), R070 (before_exit contract). **[S33] The nine remaining ids are DISPUTED, not merely open** — §6 amendment 1 (session28) declares *"P8 marked done"* and names eight of them as discharged (R047, R063, R069 answered; R057 as three named surfaces; R064/R074/R075/R078 as the merge), but this row was never amended to match. **Owner ruling 2026-08-09: walk all nine against Decision 30 and against the tree**, starting from §6's claim as a hypothesis rather than re-deriving. R057, R074, R078, R079, R047, R063, R064, R069, R075. **R079 is a ruling, not a check** — held open by `../reviews/S28-merge-plan.md:170` | P2–P7 | **[S33] the walk is owed BEFORE P14c**, which moves and deletes test cases in the same files. Do NOT restructure tests before the code stops moving |
...
- **Rule 4 stated as a complete mechanism**, so a reviewer does not rediscover the
