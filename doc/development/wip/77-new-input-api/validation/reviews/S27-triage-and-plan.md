...
| **P-21-06** **RUNNING [S43]** | **Close the two P-21-05 findings** — add the missing `ctrl+shift+s` coverage (proved by deliberately breaking row 4 first), and correct the numbers in the execution report in place, marked as amended. Prompt of record `../prompts/S43-P-21-06-review-fixes.md` | P-21-05 | production code is **not** to be touched; the sweep was reviewed clean |
| **P-21-03** | **Remove maze/draw's risk note** (`7947ac3` in the nested repo) and confirm the four-variant Shift+Escape family end to end; the note's stated removal condition is met once P-21-02 lands | P-21-02 | nested repo commit, never pushed |
| **P-21-04** | **Docs and the PR line.** P10's reserved-combo section states what a reservation claims; the debt entry "The gate reserves tolerantly; projects must register exactly" closes, pointing at Decision 33; the justification line is drafted — this is a framework behaviour change inside an input-API mandate and a stakeholder will ask | P-21-03 | last, after behaviour settles |
