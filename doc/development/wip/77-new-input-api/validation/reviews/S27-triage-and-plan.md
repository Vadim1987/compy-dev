...
| **P-21-05** **RUNNING [S43]** | **Cold review of the sweep** — prompt of record `../prompts/S43-P-21-05-cold-review.md`. Runs **before** P-21-03 and P-21-04, since both depend on the sweep being sound. Numbered after them only because they were drafted first | P-21-02 | cold agent, read-only; parent evaluates rather than relays |
