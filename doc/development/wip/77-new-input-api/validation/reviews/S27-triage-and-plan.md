...
| **P-24-01** **awaiting owner choice** | Execute the chosen option. Behaviour-preserving: the fifteen-plus live cases from P-21 and P-23 are the proof, and **no test should need editing** — a changed test is a finding, not a fix | P-24-00 | suite stays **968 / 0 / 0 / 10**; cold review after, per the standing directive |
