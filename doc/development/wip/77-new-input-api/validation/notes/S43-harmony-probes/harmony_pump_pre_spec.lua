...
local function setup_harmony()
  ...
  package.path = '/tmp/claude-1000/-repo/dd5c60bf-2db0-4ba1-83e0-cc2aa4b248ec/scratchpad/pre/?.lua;' .. package.path
...
describe('harmony under the real push/pump split', function()
  it('delivers Ctrl+T as a bare t — the modifier is already released', function()
    ...
    print('release_keys present:', tostring(harmony.utils.release_keys ~= nil))
