# Feature #77 — Blocking Decisions (per-decision record of rationale)
_Generated by LLM(Claude Opus 4.8): 2026-06; moved to notes/ + ledger relocated to status.md 2026-06-16 (E4); Approved by human?: NOT YET;_
Derived from: [`../requirements.md`](../requirements.md), [`../context.md`](../context.md), [`input.md`](input.md), [`input/`](input/), [`../status/archive/validation/`](../status/archive/validation/)

> **Role.** The authoritative **per-decision rationale of record** for D-1…D-10 (ingest/notes
> tier). The **convergence ledger + resolution track + status** now live in
> [`../status.md`](../status.md) (the dashboard owns them, so convergence is *derived*, not
> restated here). The complementary *working analysis* is [`decisions.md`](decisions.md). This
> file keeps the full Question / Context / Affects / Source / Decision detail per decision.
>
> **Status (see [`../status.md`](../status.md)):** CONVERGED — D-1…D-7 stakeholder-settled;
> D-8/D-9/D-10 architect's discretion, owner-ruled to proceed. (The pre-E4 header asserting
> "D-2…D-10… none stakeholder-approved" was stale/self-contradictory; corrected via E1.)
> Round axes: **SR** = stakeholder (SR1 `input.md` 2026-06-06; SR2 `input/stakeholder2_notes.md`
> 2026-06-10) vs **VR** = validation (VR1–VR3, 2026-06-08), per [`../agents/process.md`](../agents/process.md) §4.
