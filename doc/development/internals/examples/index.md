...
| [sapper](sapper.md) | Minesweeper (pen-and-paper) with click-driven board | pen-and-paper | `compy.input.hooks.singleclick`, `compy.input.hooks.doubleclick`, `compy.input.shortcuts.singleclick` (modifier classes) |
