...
- `#lifecycle` (`input_widget_callbacks_spec`, the `the same lifecycle on every route` group) — the one-lifecycle claim: Enter submits and Escape cancels identically in the console, the editor and a project overlay.
